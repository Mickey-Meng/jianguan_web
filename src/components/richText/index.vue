<template>
  <div class="vue-quill-editor">
    ...
    />
    <selectImage ref="selectImage" @uploadSuccess="uploadSuccess"></selectImage>
  </div>
</template>
...
<script>
  ...
  export default {
    ...
    computed: {
      editor() {
        return this.$refs["mwQuillEditor"].quill;
      }
    },
    mounted() {
    },
    methods: {
      ...
      changeQuillEditor() {
        // console.log(this.html, 11);
      }
    },
    components: {quillEditor, selectImage},
    beforeDestroy() {
    }
