    ...
    <el-main>
      <div class="container">
        <el-table :data="tableData" style="width: 100%" border height="calc(100% - 48px)" class="have_scrolling">
          ...
          <el-table-column prop="materialApproachContent" align="center" label="材料进场内容" show-overflow-tooltip></el-table-column>
          <el-table-column prop="materialApproachQuantity" align="center" label="材料进场数量" show-overflow-tooltip></el-table-column>
          <el-table-column prop="status2" align="center" label="审核状态" show-overflow-tooltip>
...
import edit from '../materialAcceptance/edit.vue';
import detail from '../materialAcceptance/detail.vue';
import {deletematerialAcceptance, getmaterialAcceptanceList} from "@/api/materialAcceptance.js";
...
export default {
  ...
  methods: {
    ...
    query() {
      ...
      api.getmaterialAcceptanceList(this.queryData).then((res) => {
    ...
    deleteRow(row) {
      this.$confirm('确认是否删除?', '提示', {
        ...
        api.deletematerialAcceptance(row['id']).then((res) => {
