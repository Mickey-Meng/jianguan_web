  ...
  <div class="nvestment_status_seport">
    <div class="left_container">
      ...
      <div class="chart_box" :class="{ isFullScreen: isFullScreen }">
        <div><span>45</span><span>.77</span></div><!--  #638 lrj 20230902 此页面是静态数据更改不迁移到建管项目 -->
  ...
  .right_container {
    ...
    ::v-deep.el-select {
      ...
      .el-input {
        ...
        .el-input__inner {
          ...
          background-color: rgba(40, 97, 246, .1);
          border: none;
          height: 100%;
          line-height: 100%;
          color: #FFFFFF;
    ...
    .item {
      ...
      >div:nth-of-type(1) {
        ...
        color: #34C5C9;
        line-height: 41px;
        background: linear-gradient(180deg, #FFFFFF 70%, #2861F6 90%, #2861F6 100%);
