...
<script>
    let nameList = ["池州市急救中心建设项目", "池州港乌沙港区共用码头工程项目", "池州市平天湖东部区域棚户区改造建设工程EPC总承包", "池州职业技术学院实验实训南区EPC总承包项目","清溪大道改造工程"];
    // let colorList = ["#D3B020", "#479C39", "#FF8A40", "#729AE0"];
    let colorList = ["#729AE0", "#FF8A40", "#479C39", "#D3B020", "#FF8A40"];
    export default {
        props: [],
        watch: {},
        data() {
            return {
              ...
              {
                  a: "池州市平天湖东部区域棚户区改造建设工程EPC总承包",
                  b: "开工",
                  c: "2022.01.18"
              },
              {
                  a: "池州职业技术学院实验实训南区EPC总承包项目",
                  b: "开工",
                  c: "2022.01.16"
              },
              {
    ...
    methods: {
      init() {
          let valueLists = [2.6, 3.2, 6.4, 5.5, 8.9];
