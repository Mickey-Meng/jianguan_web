...
<template>
  <div class="schedule_management">
    ...
    <div class="content" :class="{ isTable: currentKey === '2' }">
      ...
      <el-table v-if="currentKey === '2'" :data="tableData" height="calc(100% - 20px)" class="quality_safety"
        style="width: 100%">
        <el-table-column prop="a" align="center" show-overflow-tooltip label="项目名称">
        </el-table-column>
        <el-table-column prop="b" align="center" width="100" show-overflow-tooltip label="关键节点">
        </el-table-column>
        <el-table-column prop="c" width="110" label="日期">
        </el-table-column>
      </el-table>
    </div>
