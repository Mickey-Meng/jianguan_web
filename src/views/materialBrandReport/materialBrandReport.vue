...
<script>
import * as api from "@/api/materialBrandReport.js";
import edit from '../materialBrandReport/edit.vue';
import detail from '../materialBrandReport/detail.vue';
...
export default {
  ...
  methods: {
    ...
    query() {
      ...
      api.getMaterialBrandReportList(this.queryData).then((res) => {
    ...
    deleteRow(row) {
      this.$confirm('确认是否删除?', '提示', {
        ...
        api.deleteMaterialBrandReport(row['id']).then((res) => {
