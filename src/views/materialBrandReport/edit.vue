                    ...
                    <div class="block-item">
                      ...
                      <div class="block-item-value">
                        <el-form-item prop="remark">
                          <el-input v-model="formData.materialBrand"></el-input>
                        </el-form-item>
                      </div>
                    </div>
...
export default {
  ...
  methods: {
    ...
    getDetail(id) {
      api.getMaterialBrandReportDetail(id).then((res) => {
        let data = res['data'] || {};
        this.formData = data;
    ...
    addOrModify(isdraft) {
      this.$refs['ruleForm'].validate((valid) => {
        if (valid) {
          ...
          api.addOrUpdateMaterialBrandReport(this.formData).then((res) => {
            if (res.data) {
              this.$message({
                type: 'success',
                message: '提交成功!'
