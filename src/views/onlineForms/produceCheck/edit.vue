  ...
  export default {
	...
	methods: {
	  ...
	  changeVisible(obj,value) {
		...
		// 根据构建ID和工序ID查询待填写文档
		listProduceDocument({documentType : 2, componentId : this.editRow.conponentid, produceId : obj.produceid}).then((res) => {
	  ...
	  handleSubmit() {
		...
		reportRecord.conpoentid = this.editRow.conponentid;
