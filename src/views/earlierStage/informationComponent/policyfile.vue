 ...
 * @LastEditTime: 2022-02-17 14:20:53
-->
<template>
  <div class="wrapper">
    <el-table :data="tableData" height="100%" border style="width: 100%">
      <el-table-column prop="uploadname" label="文件名称" align="center">
      </el-table-column>
      <el-table-column prop="uploadtype" label="文件类型" align="center">
      </el-table-column>
      <el-table-column prop="callunit" label="发布单位" align="center">
      </el-table-column>
      <el-table-column prop="calltime" label="发布日期" align="center">
      </el-table-column>
      <el-table-column prop="opiontion" label="文件编码" align="center">
      </el-table-column>
