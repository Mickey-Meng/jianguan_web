<template>
  <div>
                    ...
                    <el-table :data="equipmentTable" style="width: 100%" border class="have_scrolling">
                      ...
                      <el-table-column fixed="right" width="120" align="center" label="操作">
                        <template slot-scope="{ row, $index }">
                          <el-button type="text" size="mini" @click="editEquip(row)">编辑
                          </el-button>
    ...
    <el-dialog class="defined-dialog" title="编辑" :visible.sync="equipmentVisible">
    ...
    <el-dialog width="80%" class="little-container" :visible.sync="draftVisible">
      <equipmentExitForInspection @hideDraft="hideDraft" @getDetail="getDetail" :isDraft="draftVisible"
        v-if="draftVisible">
