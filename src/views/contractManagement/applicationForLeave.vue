              ...
              <div class="form-block">
                ...
                <div class="block-line">
                  <div class="block-item">
                    ...
                    <div class="block-item-value">
                      <el-date-picker v-model="leaveTime" @change="changeTime" v-if="isCreate" type="datetimerange"
                    ...
                    <div class="block-item-value">
                      <el-form-item prop="projectChargeUser" v-if="isCreate">
                        <el-select v-model="form.handoffPersonId" filterable placeholder="请选择">
                          <el-option v-for="item in handoffPerson" :key="item.id" :label="item.name" :value="item.id">
                          </el-option>
                        </el-select>
                      </el-form-item>
...
export default {
  ...
  methods: {
    ...
    init() {
      ...
      // getDictDataByType({ pageNum: 1, pageSize: 999, dictType: "jg_ask_for_leave_type" }).then((res) => {
      //   this.eventType = res.rows || [];
      //   const dict = {};
      //   const dict_remark = {};
      //   data.forEach(item => {
