  ...
  methods: {
    ...
    loadFlowEntryWidgetData (params) {
      ...
      return new Promise((resolve, reject) => {
        FlowEntryController.listFlowEntryPublish(params).then(res => {
          resolve({
            dataList: res.data,
    ...
    onSetActiveStatus (row) {
      ...
      let httpCall = row.activeStatus ? FlowEntryController.suspendFlowEntryPublish(params) : FlowEntryController.activateFlowEntryPublish(params);
      httpCall.then(res => {
    ...
    getTaskProcessXml (row) {
      ...
      FlowOperationController.viewProcessBpmn(params).then(res => {
        // 当前流程实例xml
