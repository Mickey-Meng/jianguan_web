...
<script>
import commonFile_day from "./supervisordptComponent/commonFileListPage.vue";
...
export default {
  name: "",
  components: { commonFile_day,commonFile_week,commonFile_month},
  data() {
    return {
