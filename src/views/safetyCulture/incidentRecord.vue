    ...
    <el-main>
      ...
      <div class="container">
        <el-table :data="tableData" style="width: 100%" border height="100%" class="have_scrolling">
          ...
          <el-table-column prop="pro" align="center" label="单位工程" show-overflow-tooltip>
          </el-table-column>
          <el-table-column prop="safefirstname" align="center" label="检查大项" show-overflow-tooltip>
          </el-table-column>
          <el-table-column prop="safesecondname" align="center" label="检查小项" show-overflow-tooltip>
          </el-table-column>
          <el-table-column prop="uploadname" align="center" label="检查人员" show-overflow-tooltip>
          </el-table-column>
          <el-table-column prop="uploadtime" align="center" sortable label="检查日期" show-overflow-tooltip>
          </el-table-column>
          <!-- <el-table-column
            prop="uploadremark"
            align="center"
          ...
          <el-table-column align="center" label="事件照片">
          ...
          <el-table-column align="center" label="操作" width="150px">
            <template slot-scope="{ row, $index }">
              <el-button type="primary" class="primary_mini" size="mini" @click="seeDetail(row, $index)">详情</el-button>
              <el-button type="danger" size="mini" v-if="rolePerms[0] == 'gly'"
      ...
      <div class="detail_div">
        ...
        <ul class="event_content normal_ul">
          <li>
            ...
            <div class="content">
              {{ detalRow.safefirstname }} ->
              {{ detalRow.safesecondname }}
            </div>
          </li>
          <li>
  ...
  methods: {
    ...
    deleteInfo(row, index) {
      this.$confirm("删除信息?", "提示", {
        ...
        .then(() => {
          deleteSafeEvent({ gids: `${row.id}` }).then((res) => {
