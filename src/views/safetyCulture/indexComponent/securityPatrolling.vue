<template>
  <div class="wrapper">
    ...
    <div class="bottom">
      <div class="table">
        <div class="header">
          <el-button size="mini">安全事件</el-button>
          <el-date-picker
            v-model="timeValue"
            type="datetime"
...
<!--      <div class="map">-->
<!--        <div class="header">-->
<!--          <el-button size="mini">巡更地图</el-button>-->
<!--          <ul class="legend">-->
<!--            <li><img src="../../../assets/image/signIn.png" alt="">签到/签退</li>-->
<!--            <li><img src="../../../assets/image/card.png" alt="">打卡位置</li>-->
<!--            <li><img src="../../../assets/image/wenti.png" alt="">问题位置</li>-->
<!--          </ul>-->
...
<script>
  ...
  import timeTable from '@/views/safetyCulture/indexComponent/timeTable'
