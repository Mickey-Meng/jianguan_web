...
<template>
  <el-container class="container-box">
    <el-header>
      ...
      <div class="input-box">
        <div class="input-value">
          <el-date-picker value-format="yyyy-MM-dd" v-model="queryData.buildDateStart" type="date"
                          placeholder="计划开工结束日期">
          </el-date-picker>
        </div>
      </div>
      <div class="input-box">
...
export default {
  ...
  methods: {
    ...
    exportData() {
      ...
      api.exportFirstAcceptList(this.queryData).then((res) => {
        const reader = new FileReader();
        reader.readAsDataURL(res);
        reader.onload = (e) => {
          const a = document.createElement('a');
          a.download = `首件认可清单.xls`;
