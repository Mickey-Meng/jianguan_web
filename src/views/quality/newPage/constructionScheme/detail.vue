						...
						<div class="form-content">
							<el-form ref="form" label-width="80px">
								...
								<div class="form-block">
									...
									<attachlist :editAble="false" ref="attachlist" :attachTable="buildPlanAttachTable">
									</attachlist>
								</div>
								<div class="form-block">
									<div class="form-block-title">
									...
									<attachlist :editAble="false" ref="attachlist" :attachTable="expertMeetingAttachTable">
									</attachlist>
								</div>
								<div class="form-block">
									<div class="form-block-title">
									...
									<div class="block-line">
										<div class="block-item">
											...
											<div class="block-item-value">
												<el-switch disabled :active-value="0" :inactive-value="1"
													style="display: block" v-model="formData.expertArgument"
								...
								<div class="form-block">
									...
									<attachlist :editAble="false" ref="attachlist" :attachTable="replyAttachTable">
									</attachlist>
								</div>
								<!-- <div class="form-block">
									<div class="form-block-title">
