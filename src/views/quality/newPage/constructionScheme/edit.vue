<template>
	<div>
						...
						<div class="form-content">
							<el-form :model="formData" :rules="rules" ref="ruleForm" label-width="80px">
								<div class="form-title">
									...
									<!-- #644 lrj 拼接标段改为写死浙公路（JL）011 -->
									<!-- <strong>施工方案-{{ project.name }}</strong> -->
									<strong>施工方案-浙公路（JL）007</strong>
								...
								<div class="form-block">
									...
									<div class="block-line">
										...
										<div class="block-item">
											...
											<div class="block-item-value">
												<el-input v-model="formData.attachmentList" type="textarea"
													:rows="4"></el-input>
											</div>
										</div>
									</div>
								...
								<div class="form-block">
									...
									<attachlist :editAble="true" ref="attachlist" :attachTable="buildPlanAttachTable">
									</attachlist>
								</div>
								<div class="form-block">
									<div class="form-block-title">
									...
									<attachlist :editAble="true" ref="attachlist" :attachTable="expertMeetingAttachTable">
									</attachlist>
								</div>
								...
								<div class="form-block">
									...
									<div class="block-line">
										<div class="block-item">
											...
											<div class="block-item-value">
												<el-switch :active-value="0" :inactive-value="1" style="display: block"
													v-model="formData.expertArgument" active-color="#13ce66"
									...
									<div class="block-line">
										<div class="block-item">
											...
											<div class="block-item-value">
												<el-input v-model="formData.expertOpinion" type="textarea" :rows="4"
													:disabled="formData.expertArgument == 1"></el-input>
											</div>
										</div>
										<div class="block-item">
											<div class="block-item-label">专家论证意见的落实情况</div>
											<div class="block-item-value">
												<el-input v-model="formData.expertOpinionImplement" type="textarea"
													:rows="4" :disabled="formData.expertArgument == 1"></el-input>
											</div>
										</div>
									</div>
								</div>
								<div class="form-block">
									...
									<attachlist :editAble="true" ref="attachlist" :attachTable="replyAttachTable">
									</attachlist>
								</div>
		...
		<el-dialog width="80%" class="little-container" :visible.sync="draftVisible">
			<constructionScheme @hideDraft="hideDraft" @getDetail="getDetail" :isDraft="draftVisible" v-if="draftVisible">
			</constructionScheme>
		</el-dialog>
	</div>
</template>
