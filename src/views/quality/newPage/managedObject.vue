					...
					<el-table-column fixed="right" width="120" align="center" label="操作">
						<template slot-scope="{ row, $index }">
							...
							<el-button type="text" style="color: red;"
								...
								@click="deleteManagementObject(row.id)">删除</el-button>
						</template>
					</el-table-column>
				</el-table>
							...
							<el-form ref="form" label-width="80px">
								...
								<div class="form-block">
									...
									<div class="block-line">
										<div class="block-item">
											...
											<div class="block-item-value">
												<el-input placeholder="请输入内容" v-model="formData.registrationDepartment"
													:disabled="previewMode"></el-input>
											</div>
										</div>
										<div class="block-item">
											<div class="block-item-label">登记人<i class="require-icon"></i></div>
											<div class="block-item-value">
												<el-input placeholder="请输入内容" v-model="formData.registrant"
													:disabled="previewMode"></el-input>
									...
									<div class="block-line">
										...
										<div class="block-item">
											...
											<div class="block-item-value">
												<el-date-picker type="date" v-model="formData.publishDate"
													placeholder="选择日期" :disabled="previewMode"></el-date-picker>
											</div>
										</div>
										...
										<div class="block-item">
											...
											<div class="block-item-value">
												<el-input placeholder="请输入内容" v-model="formData.title"
													:disabled="previewMode"></el-input>
											</div>
										</div>
									</div>
								...
								<div class="form-block">
									<div class="form-block-title">
										...
										<span style="font-size: 12px;margin-left: 40px;" v-show="!previewMode">支持上传 jpg/jpeg
											png mp4 docx doc xlsx xls pdf 文件，且不超过 50M</span>
									</div>


									<attachlist :editAble="!previewMode" ref="attachlist" :attachTable="attachTable">
									</attachlist>

								</div>
								<div class="form-block">
									<el-button class="submit-btn" size="small" type="primary" @click="addManagedObject"
										v-show="!previewMode">提交</el-button>
								</div>
							</el-form>
						</div>
					</div>
