...
<template>
	<el-container class="container-box">
		<el-header>
			...
			<div class="input-box">
				<div class="input-value">
					<el-input placeholder="旁站人" v-model="queryData.createName"></el-input>
				</div>
			</div>
			<div class="input-box">
				<div class="input-value">
					<el-date-picker v-model="queryData.sideDateStart" type="date" placeholder="旁站开始时间">
					</el-date-picker>
				</div>
			</div>
			<div class="input-box">
				<div class="input-value">
					<el-date-picker v-model="queryData.sideDateEnd" type="date" placeholder="旁站结束时间">
					</el-date-picker>
				</div>
			</div>
		...
		<el-main>
			<div class="container">
				<el-table :data="tableData" style="width: 100%" border height="calc(100% - 48px)"
					...
					<el-table-column prop="projectPartName" align="center" label="工程部位" show-overflow-tooltip>
					</el-table-column>
...
<script>
	...
	import edit from './supervisionStation/edit';
	import detail from './supervisionStation/detail';
		...
		methods: {
			...
			deleteRow(row) {
				this.$confirm('确认是否删除?', '提示', {
					...
					api.deleteSupervisionSide(row['id']).then((res) => {
