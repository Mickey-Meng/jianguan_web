...
<!--                    </div>-->
                ...
                <div class="form-block">
                  ...
                  <attachlist :editAble="true" ref="attachlist" :attachTable="samplePhoto"></attachlist>
                </div>
                <div class="form-block">
                  <div class="form-block-title">
...
export default {
  ...
  data() {
    return {
      ...
      auditUser: {},
      approveVisible:true,
      flowKey:'materialSampleConfirmation',
      dataDictionaryList: []
    };
  },
  created() {
    ...
    addOrModify(isdraft) {
      this.$refs['ruleForm'].validate((valid) => {
        if (valid) {
          ...
          this.formData.samplePhoto = this.samplePhoto;
          ...
          api.addOrUpdateMaterialSampleConfirmation(this.formData).then((res) => {
            if (res.data) {
              this.$message({
                type: 'success',
                message: '提交成功!'
