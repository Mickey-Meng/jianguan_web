...
<script>
import * as api from "@/api/certificate/progressCertificatePhotos";
...
export default {
  ...
  methods: {
    ...
    query() {
      ...
      api.getProgressCertificatePhotosList(this.queryData).then((res) => {
    ...
    deleteRow(row) {
      this.$confirm('确认是否删除?', '提示', {
        ...
        api.deleteProgressCertificatePhotos(row['id']).then((res) => {
