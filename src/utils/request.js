		...
		if (config.url.indexOf('STSfmzj') != -1) {} else {
			if (store.getters.token) {
				config.headers['token'] =
					'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE2NTI5NDg3MTYsInVzZXIiOiJ7XCJnb25ncXVzXCI6W10sXCJpZFwiOjEsXCJwcm9qZWN0c1wiOltdLFwicm9sZVwiOjJ9In0.PDzI9daFON3xI1GFjQzU7c7fzRATj0hXbBXTYJQSUm4' //getToken('zj_token')
			}
		}
