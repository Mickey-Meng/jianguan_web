layui.define(["jquery"], function(a) {
    ...
    var b = {
        ...
        show: function (f, d, k, h) {
            ...
            b.setEvents(f, h);
            c(".ctxMenu-item.haveMore").on("mouseenter",
                function () {
                    var e = c(this).find(">a");
                    var l = c(this).find(">.ctxMenu-sub");
                    var n = e.offset().top;
                    var m = e.offset().left + e.outerWidth();
                    if (m + l.outerWidth() > b.getPageWidth()) {
                        m = e.offset().left - l.outerWidth()
                    }
                    if (n + l.outerHeight() > b.getPageHeight()) {
        ...
        setEvents: function (d, f) {
            c(".ctxMenu").off("click").on("click", "[lay-id]",
                function (h) {
    ...
    c(document).off("click.ctxMenu").on("click.ctxMenu",
        function () {
            b.remove()
        });
    c(document).off("click.ctxMenuMore").on("click.ctxMenuMore", ".ctxMenu-item",
        function (d) {
