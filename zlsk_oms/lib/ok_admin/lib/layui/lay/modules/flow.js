...
layui.define('jquery', function(exports){
  ...
  Flow.prototype.lazyimg = function(options){
    ...
    //加载图片
    if(options.pictures && options.pictureContent){
      var pictureContent = $(options.pictureContent);
      options.pictures.forEach(function (value) {
        var child = '<img lay-src="'+ value +'">';
        pictureContent.append(child);
      });
    }
