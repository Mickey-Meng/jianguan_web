...
;!function(){
  ...
  */
  ...
  Class.prototype.mark = function(td, YMD){
    ...
    if(mark){
      if(options.isZMark){
        var color = mark === '待巡检' ? '#ffb800' : mark === '已逾期' ? '#FF0000' : '#01aaed';
        td.html(YMD[2] + '<span class="laydate-day-mark" style="color:'+ color +';font-weight:bold;">'+ mark +'</span>');
      }else {
        td.html('<span class="laydate-day-mark">'+ mark +'</span>');
      }
    }
