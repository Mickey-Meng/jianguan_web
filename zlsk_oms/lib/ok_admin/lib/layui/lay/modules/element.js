...
layui.define('jquery', function(exports){
  ...
  Element.prototype.tabAdd = function(filter, options){
    ...
    ,titElem = tabElem.children(TITLE).length === 0 ? tabElem.children('.layui-tab-title-father').children(TITLE) : tabElem.children(TITLE)
  ...
  ,call = {
    ...
    ,tabAuto: function(){
      ...
      $('.layui-tab').each(function(){
        var othis = $(this)
        ,title = othis.children('.layui-tab-title').length === 0 ? othis.children('.layui-tab-title-father').children('.layui-tab-title') : othis.children('.layui-tab-title')
