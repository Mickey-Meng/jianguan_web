(function(factory, ctx, undefined) {
    ...
    var ImageTrans = function(container, options) {
        ...
        if (this._support) {
            ...
            this.onError(-8001, '浏览器不支持css3,filter或canvas');
        }
    };
    ImageTrans.prototype = {
        _initialize: function(container, options) {
            ...
            this._img = new Image();
            this._style = {};
            this._x = this._y = 1;  // scale  param
            this._radian = 0;       // rotate param
            this._support = false;
        ...
        _setOptions: function(options) {
            this.options = {
                ...
                onPreLoad: function() {},
                onLoad: function() {},
                onError: function(statusCode, msg) {}
            };
        ...
        load: function(src) {
            if (this._support) {
                ...
                img.onerror || (img.onerror = function() { oThis.onError(-5003, '图片加载失败'); });
        ...
        reset: function() {
            if (this._support) {
                var img = this._img;
                var dRateC = this._clientWidth / this._clientHeight;
                var dRateI = img.clientWidth / img.clientHeight;
                var dRate = "1";

                if (dRateI > dRateC) {
                    dRate = this._clientWidth / img.clientWidth;
                } else {
                    dRate = this._clientHeight / img.clientHeight;
                }
        ...
        return {
            css3: {
                ...
                show: function() {
                    ...
                    this._img.style[css3Transform] = "matrix(" + matrix.M11.toFixed(16) + "," + matrix.M21.toFixed(16) +
    ...
    ImageTrans.transforms = {
        ...
        //根据角度旋转
        rotateByAngle: function(angle) { this._radian = angle * Math.PI / 180; },
        //缩放
        scale: function() {
