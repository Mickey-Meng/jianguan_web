        ...
        function(e) {
            ...
            function P() {
                ...
                return function() {
                    ...
                    for (var r = a,
                             n = o[a].apply(null, e); r--;) n = o[r].call(null, n);
                    return n
                }
            }
            var b = Math.sin,
            ...
            function W(e) {
                var t = e[0],
                    r = e[1];
                if (!J(t, r)) return [t, r];
                for (var n = [t, r], o = n[0], a = n[1], i = x([o, a]), u = i[0] - t, f = i[1] - r; 1e-6 < B(u) || 1e-6 < B(f);) u = (i = x([o -= u, a -= f]))[0] - t,
                    f = i[1] - r;
                return [o, a]
            }
            function x(e) {
                ...
                var n = function(e, t) {
                    var r = function(e, t) {
                            ...
                            return r += 2 * (20 * b(6 * e * D) + 20 * b(2 * e * D)) / 3,
            ...
            function ae(e, t, r) {
                e || m("coordinate is required"),
                t || m("original coordinate system is required"),
                r || m("target coordinate system is required");
                var n = oe[t];
                ...
                return i ? u(e) : (function e(t, r, n) {
                    if (void 0 === n && (n = !1), null !== t) for (var o, a, i, u, f, c, s, l, M = 0,
                                                                       g = 0,
                                                                       h = t.type,
                                                                       v = "FeatureCollection" === h,
                                                                       d = "Feature" === h,
                                                                       G = v ? t.features.length: 1, S = 0; S < G; S++) {
