/**
 * filename:sliderMgr.js
 * desc:earth environment controled by slider
 * deps:
 * authors:zc
 * time:2015-01-21 ‏‎‏‎‏‎10:17:00
 * version:0.0.1
 * updatelog:
    ...
    var _sliderMgr = {
        ...
        setVisible: function(type, visible) {
            ...
            if (visible && !slider.slider) {
                ...
                slider.slider = s;
                _onSlider_changed(s.ID, 100);
            }
            if(slider.visible != visible){
