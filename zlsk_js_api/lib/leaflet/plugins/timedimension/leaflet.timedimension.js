...
///*
//* L.TimeDimension.Layer.ArrData:
//*/

//L.TimeDimension.Layer.ArrData = L.TimeDimension.Layer.extend({

//    initialize: function (options) {
//        L.TimeDimension.Layer.prototype.initialize.call(this, null, options);
//        this._updateTimeDimension = this.options.updateTimeDimension || false;
//        this._updateTimeDimensionMode = this.options.updateTimeDimensionMode || 'extremes'; // 'union', 'replace' or extremes
//        this._duration = this.options.duration || null;
//        this._addlastPoint = this.options.addlastPoint || false;
...
//        // new coordinates:
//        var layer = L.geoJson(null, this.options.geoJsonOptions);

//        var layers = this.options.data;

//        for (var i = 0, l = layers.length; i < l; i++) {
//            var feature = this._getFeatureBetweenDates(layers[i], minTime, maxTime);
//            if (feature) {
//                layer.addData(feature);
//                if (this._addlastPoint && feature.geometry.type == "LineString") {
//                    if (feature.geometry.coordinates.length > 0) {
...
//L.timeDimension.layer.arrData = function (layer, options) {
//    return new L.TimeDimension.Layer.ArrData(layer, options);
//};
...
*/
    ...
    _getDisplayDateFormat: function (date) {
        return this._dateUTC ? date.toISOString() : date.format("yyyy-M-d HH:mm:ss");  //date.toLocaleString();
    },
