...
* Leaflet.LabelTextCollision 是一个LeafletJS插件，用于显示矢量数据上的标签，同时避免标签碰撞。
*/
L.LabelTextCollision = L.Canvas.extend({
    ...
    _initContainer: function (options) {
        ...
        this._containerText.id = 'canvasLayer';
        this._containerText.style.position = 'absolute';
        this._containerText.style.top = 0;
        this._containerText.style.left = 0;
    ...
    _update: function () {
        ...
        var b = this._bounds, container = this._containerText, size = b.getSize(), m = L.Browser.retina ? 2 : 1;
